...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::stockfish::ListenerSubscription> final {
    static inline margelo::nitro::stockfish::ListenerSubscription fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::stockfish::ListenerSubscription(
        JSIConverter<std::function<void()>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "remove")))
      );
    }
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::stockfish::ListenerSubscription& arg) {
